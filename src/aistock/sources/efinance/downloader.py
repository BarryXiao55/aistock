"""EFinance SourceNode implementation."""
...
from aistock.sources.efinance.mapper import map_daily_columns, unify_code


class EFinanceSource(SourceNode):
    """EFinance 数据源实现"""
    ...
    def __init__(self, config: dict | None = None):
        ...
        self._client = EFinanceClient(self._config)

    def supports(self, asset_type: str, schema: type) -> bool:
        """声明支持的数据类型"""
        return asset_type in ["stock", "fund", "futures"] and schema == StockDailySchema
