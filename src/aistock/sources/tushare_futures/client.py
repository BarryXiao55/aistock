"""Tushare futures API client wrapper."""
...
class TuShareFuturesClient:
    ...
    def get_futures_basic(self) -> pd.DataFrame:
        """获取期货合约基本信息"""
        ts_api = self._get_tushare()
        ...
        try:
            ...
            df = ts_api.fut_basic(exchange="", fields="ts_code,symbol,name,delist_date,list_date")
    ...
    def check_health(self) -> bool:
        ...
        try:
            ts_api = self._get_tushare()
            # 尝试获取期货合约列表
            df = ts_api.fut_basic(exchange="", fields="ts_code")
