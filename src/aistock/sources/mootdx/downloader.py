"""Mootdx SourceNode implementation."""
...
class MootdxSource(SourceNode):
    ...
    def __init__(self, config: dict | None = None):
        ...
        self._client = MootdxClient(self._config)

    def supports(self, asset_type: str, schema: type) -> bool:
        """声明支持的数据类型"""
        return asset_type in ["stock", "index"] and schema == StockDailySchema
